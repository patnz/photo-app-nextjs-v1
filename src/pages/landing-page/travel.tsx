    ...
    <>
      ...
      >
        ...
        <ul className="mx-auto my-12 flex list-none flex-col justify-around gap-5 sm:flex-row">
          ...
          <li className="flex flex-col items-center rounded-3xl border border-2 bg-white px-2 py-2 shadow-xl dark:border-rose-950 dark:bg-stone-900 sm:w-5/6 md:w-1/5">
            <Image
