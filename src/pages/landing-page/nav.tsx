      ...
      {burgerClicked ? (
        <header className="h-30 fixed top-0 z-10 w-full bg-stone-700 text-stone-100">
          <section className="mx-auto flex max-w-[100vw] items-center justify-evenly py-4">
            <nav
              className="space-x-3 font-caveat text-xl sm:block"
              aria-label="main"
            >
              <Link href="/" className=" p-1 hover:opacity-90">
                Home
              </Link>
              <Link href="/festivals" className="p-1 hover:opacity-90">
                Festivals
              </Link>

              <Link href="/gigs" className="p-1 hover:opacity-90">
                Gigs
              </Link>

              <Link href="/travels" className="p-1 hover:opacity-90">
                Travel
              </Link>
